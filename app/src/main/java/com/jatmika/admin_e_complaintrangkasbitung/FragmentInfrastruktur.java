 ...
 */
public class FragmentInfrastruktur extends Fragment implements RecyclerAdapterKomplain.OnItemClickListener {
    ...
    private void openDetailKomplainInfrastruktur(String[] data){
        Intent intent = new Intent(getActivity(), DetailInfrastrukturActivity.class);
    ...
    private String jumlahKomplainInfrastruktur, jumlahKomplainIUMK, jumlahKomplainKependudukan, jumlahKomplainKTP,
            jumlahKomplainNikah, jumlahKomplainSPPT, jumlahKomplainTutupJalan;

    public FragmentInfrastruktur() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_infrastruktur, container, false);
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Query query = mDatabaseRef.orderByChild("kategori").equalTo("Komplain Infrastruktur");
                        ...
                        FirebaseDatabase.getInstance().getReference("data_komplain").orderByChild("kategori").equalTo("Komplain Infrastruktur").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()){
                                    ...
                                    double komplainInfrastruktur = Double.parseDouble(String.valueOf(totalData));
                                    ...
                                    mDialog.dismiss();
                                    Toast.makeText(FragmentInfrastruktur.this.context, "Komplain telah dihapus!", Toast.LENGTH_SHORT).show();

                                } else {
                                    FirebaseDatabase.getInstance().getReference("data_persentase_komplain").child("Komplain Infrastruktur").child("jumlah_komplain").setValue("0")
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void aVoid) {
                                                    showJumlahKomplain();

                                                    double komplainInfrastruktur = 0;
                                                    double komplainIUMK = Double.parseDouble(jumlahKomplainIUMK);
                                                    double komplainKependudukan = Double.parseDouble(jumlahKomplainKependudukan);
                                                    double komplainKTP = Double.parseDouble(jumlahKomplainKTP);
                                                    double komplainNikah = Double.parseDouble(jumlahKomplainNikah);
                                                    ...
                                                    if (komplainIUMK == 0 && komplainKependudukan == 0 && komplainKTP == 0 && komplainNikah == 0
                                                            && komplainSPPT == 0 && komplainTutupJalan == 0) {
                                                        FirebaseDatabase.getInstance().getReference("data_persentase_komplain").child("Komplain Infrastruktur").child("persen").setValue("0.0");
                                                        mDialog.dismiss();
                                                        Toast.makeText(FragmentInfrastruktur.this.context, "Komplain telah dihapus!", Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(int position) {
        ...
        openDetailKomplainInfrastruktur(komplainData);
    }
